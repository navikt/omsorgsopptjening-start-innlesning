...
class BarnetrygdmottakerKafkaListener(
    ...
    fun poll(
        ...
        try {
            ...
            //TODO dersom vi leser fra to forskjellige innesinger vil begge være med i listen her siden vi ikke helt vet hvilken som feilet - sjekker status i InnlesingInvalidatingRetryListener - finne en bedre løsning?
